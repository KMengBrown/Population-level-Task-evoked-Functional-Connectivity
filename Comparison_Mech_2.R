...
write.csv(est_results_matrix, file = "est_results_matrix.csv")
write.csv(naive_Pearson_mean, file = "naive_Pearson_mean.csv")
write.csv(naive_Pearson_median, file = "naive_Pearson_median.csv")
write.csv(task_Pearson_mean, file = "task_Pearson_mean.csv")
write.csv(task_Pearson_median, file = "task_Pearson_median.csv")
write.csv(beta_series_mean, file = "beta_series_mean.csv")
write.csv(beta_series_median, file = "beta_series_median.csv")
write.csv(coherence_mean, file = "coherence_mean.csv")
write.csv(coherence_median, file = "coherence_median.csv")
...
write.csv(RATE_vector, file = "RATE_vector.csv")
